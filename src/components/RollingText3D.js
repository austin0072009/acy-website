...
const RollingText3D = () => {
	...
	return (
		<div className="flex flex-col items-center rolling-main rolling-title flex flex-col font-bold rolling-text">
          ...
          <figure className="red text-white capitalize md:uppercase">Amazing Profit <span className = "smalllabel" >IN LAUNCH</span></figure> */}
						...
						<figure className="green text-white capitalize md:uppercase">
							Optimal Output
						</figure>
						<figure className="darkgreen text-white capitalize md:uppercase">
							Extra Income
						</figure>
						<figure className="blue text-white capitalize md:uppercase">
							Stable Return
						</figure>
						<figure className="red text-white capitalize md:uppercase">
							Amazing Profit
						</figure>
						<figure className="orange text-white capitalize md:uppercase">
							Flash Arbitrage
						</figure>
						<figure className="yellow text-white capitalize md:uppercase">
							Mutual Benefit
						</figure>
					</div>
				</div>
